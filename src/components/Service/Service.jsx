  ...
  return (
    <div className="mt-[28px] font-primary">
      <Flex className="justify-between items-center">
        <div className="flex justify-end w-[50%] mr-[150px]">
          <div>
        ...
        <div className="bg-[url(./assets/service.png)] w-[50%] pt-[147px] pb-[139px] relative z-[1] bg-no-repeat bg-center bg-cover">
